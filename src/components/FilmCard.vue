<template>
  <div>
    <!-- TODO : Creer la carte d'un film -->
    <!-- - Afficher l'image, le titre, le realisateur, l'annee -->
    ...
    <!-- - Indicateur de note (vert >= 80, orange >= 60, rouge < 60) -->
    <div v-if="rt_score>=80">Afficher le score en vert</div>
